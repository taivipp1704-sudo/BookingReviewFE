  ...
  return (
    <AuthShell audience="customer">
      <section className="w-full rounded-lg border border-line bg-white p-6 shadow-[0_20px_60px_rgba(16,16,16,.09)] sm:p-9">
        ...
        <div className="mt-7 grid h-12 w-12 place-items-center rounded-lg bg-ink text-acid shadow-lg">
        ...
        <h1 className="mt-2 text-3xl font-black">{mode === "register" ? "Tạo tài khoản" : "Đăng nhập"}</h1>
        <p className="mt-2 text-sm font-semibold leading-6 text-muted">
          {loginMessage || (mode === "register"
            ? "Nhập họ tên và số điện thoại để tạo tài khoản mới."
