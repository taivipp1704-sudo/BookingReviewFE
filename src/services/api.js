...
export const api = {
  ...
  customerLoginWithPin: payload => request('/api/customer/account/login-pin', { method: 'POST', body: payload }),
  customerRegister,
  changeCustomerPassword: payload => request('/api/customer/account/password/change', { method: 'POST', body: payload }),
  setCustomerPin: payload => request('/api/customer/account/pin', { method: 'POST', body: payload }),
  disableCustomerPin: payload => request('/api/customer/account/pin/disable', { method: 'POST', body: payload }),
  ...
  customerBookingFeedback: bookingId => request(`/api/customer/account/bookings/${encodeURIComponent(bookingId)}/feedback`),
